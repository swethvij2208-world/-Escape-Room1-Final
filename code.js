...
onEvent("witch","click", function( ) {
  ...
  setScreen("gameOverScreen");
  console.log("The wicked witch zapped you");
hideLight();
hideDoor1();
hideDoor2();
hideTrap();
